...
gallery.addEventListener('click', handleModalWindow);
...
function handleModalWindow(event) {
  ...
  // Або так - event.target.classList.contains('gallery-image')
  // Або взагалі так - event.target.nodeName === "IMG"

  const showModalWindow = basicLightbox.create(`
